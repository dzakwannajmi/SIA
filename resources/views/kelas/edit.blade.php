            ...
            <form action="{{ route('kelas.update', $kela) }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_kelas" value="{{ old('kode_kelas', $kela->kode_kelas) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun_angkatan" value="{{ old('tahun_angkatan', $kela->tahun_angkatan) }}"
                               min="2000" max="2099"
                               class="w-full border rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500
