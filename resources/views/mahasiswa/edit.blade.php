            ...
            <form action="{{ route('mahasiswa.update', $mahasiswa) }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="telepon" value="{{ old('telepon', $mahasiswa->telepon) }}"
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                ...
                <div class="flex items-center gap-3 mt-6 pt-5 border-t">
                    <button type="submit"
                            class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-6 py-2 rounded-lg transition">Perbarui</button>
